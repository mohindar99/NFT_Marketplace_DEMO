...
// This method will make you to switch the network incase if you are in other networks to georli network(0x5)
  async function connectWallet() { 
    ...
    await window.ethereum.request({ method: 'eth_requestAccounts' }).then(() => {
      ...
      console.log("here");
      getAddress();
      window.AbortControllerlocation.replace(location.pathname)
    });
  }
  // This is just used to reload the page when the accounts changed 
  useEffect(() => { 
